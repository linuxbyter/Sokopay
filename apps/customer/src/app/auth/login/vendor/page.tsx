    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-semibold tracking-[-0.02em] text-text-primary mb-2">Vendor Sign In</h1>
          <p className="text-sm text-text-secondary">Create your shop and reach customers</p>
        </div>
