...
import { ChevronDown, ChevronUp, MessageSquare, Store, Search, Shield, HelpCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold tracking-[-0.02em] text-text-primary mb-2">Support Center</h1>
            ...
            return (
              <div key={section.category}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-medium text-text-primary">{section.category}</h2>
                </div>
        ...
        <div className="mt-12 bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center">
          ...
          <h3 className="font-semibold text-text-primary mb-1">Still need help?</h3>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-success hover:bg-success/90 text-white font-bold px-6 py-3 rounded-xl transition-colors text-sm"
          >
            WhatsApp Support
          </a>
          <p className="text-xs text-text-tertiary mt-2">+254 700 000 000</p>
        </div>
      </div>
    </div>
  );
